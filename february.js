const artemPage = document.querySelector('[data-page__owner="artem"]');
const vladPage = document.querySelector('[data-page__owner="vlad"]');
if (vladPage) {
...
if (artemPage){
    function revealFunction() {
        ...
        sr.reveal('header', { origin: 'top', distance: '550px', reset: false });
